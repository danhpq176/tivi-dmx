		...
		<div id='banner' className='home'>
			...
			<div id='gioi-thieu' className='intro'>
				<div className='content'>
					<span className='title'>TRUNG TÂM BẢO HÀNH VÀ SỬA CHỮA TIVI ĐIỆN MÁY XANH</span>
					<ul className='list-content'>
						<li>
							<img className='icon' src={require('../../assets/icon-1.png')} alt='icon' />
							TRUNG TÂM BẢO HÀNH VÀ SỬA CHỮA TIVI ĐIỆN MÁY XANH chuyên cung cấp dịch vụ sửa , khắc
							phục các lỗi và hư hỏng tại nhà từ những sự cố nhỏ cho đến những hư hỏng nặng.
						</li>
						<li>
							<img className='icon' src={require('../../assets/icon-1.png')} alt='icon' />
							Chúng tôi sẽ cho kĩ thuật đến tận nhà kiểm tra và báo chi phí trước khi thực hiện sửa
							chữa. ĐIỆN MÁY XANH thay thế linh kiện chính hãng chất lượng cao với giá rẻ phải
							chăng.
						</li>
						<li>
							<img className='icon' src={require('../../assets/icon-1.png')} alt='icon' />
			...
			<Container>
				<div id='sua-tivi-dienmayxanh' className='advantages'>
					<Title
						titleText={'LÝ DO NÊN CHỌN TRUNG TÂM BẢO HÀNH VÀ SỬA CHỮA ĐIỆN MÁY XANH'}
			...
			<div id='lien-he' className='footer'>
				<Container>
					...
					<div className='location'>
						<div className='left'>
							<span className='subtitle'>TRUNG TÂM SỬA CHỮA – BẢO HÀNH TIVI ĐIỆN MÁY XANH</span>
